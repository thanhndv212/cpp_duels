...
int hit_check(initMsg initMsg, int x, int y)
{
    ...
    int Gor1_xPos = initMsg.x1;
    int Gor1_yPos = initMsg.y1;
    int Gor2_xPos = initMsg.x2;
    int Gor2_yPos = initMsg.y2;
    int epl_rad = initMsg.radius ;
    int Gor1_check = int(sqrt((x-Gor1_xPos)*(x-Gor1_xPos)+(y-Gor1_yPos)*(y-Gor1_yPos)));
    cout<<x<<" ; "<<Gor1_xPos<<" ; "<<y<<" ; "<<Gor1_yPos<<"\n";
    cout<<"distance from banana to gor1: "<<Gor1_check<<"\n";
    int Gor2_check = int(sqrt((x-Gor2_xPos)*(x-Gor2_xPos)+(y-Gor2_yPos)*(y-Gor2_yPos)));
